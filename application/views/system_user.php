		...
		<section class="content">
			<section id="setsec" class="setting">
				...
				<form action="system/addUser" method="post" id="addUserForm">
					...
					<input id="user_name" type="text" autocomplete="off" name="user_name" placeholder="请输入用户名"/>
					<br />
					<label for="user_realname">昵称:</label>
					<input id="user_realname" type="text" autocomplete="off" name="user_realname" placeholder="请输入昵称"/>
					<br />
					...
					<input id="user_rept_password" type="password" autocomplete="off" name="user_rept_password" placeholder="请再次输入密码"/>
					<br />
